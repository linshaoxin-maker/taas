...
os.chdir("data/baseline/pgn/pointer-gen-cov")
filelist = []
...
for file in filelist:
    reference = file.replace('decoded','reference')
    with open(f"/Users/rachelzheng/Documents/GitHub/www/data/baseline/pgn/reference/{reference}", 'r') as f:
        line = f.read()
# for line in fgolden:
...
#     print(f"generated: {generated_list[i]}")
#     print(f"golden: {golden_list[i]}")
#     print("#############################")
