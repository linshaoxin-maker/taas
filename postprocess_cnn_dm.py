...
for line in fin:
    ...
    modified_line = modified_line.replace('[ X_SE P]', '[X_SEP]').replace('[ X_SE P', '[X_SEP] P').replace('[x_SE P]', '[X_SEP]').replace('[x_SE p', '[X_SEP] P').replace('[X_ SEP]',
                                                                                                           '[X_SEP]').replace(
        '[ X_SEp]', '[X_SEP]').replace('<S_SEP>', '[X_SEP]').replace('<S_SEB]', '[X_SEP]').replace('< X_SEB]',
                                                                                                   '[X_SEP]').replace(
        '<X_SEB>', '[X_SEP]').replace('<S_SEP]', '[X_SEP]').replace('[X_seP]', '[X_SEP]').replace('[X-SEP ]', '[X_SEP]').replace('[X-SEP]', '[X_SEP]').replace('[X-SEP)', '[X_SEP]')
